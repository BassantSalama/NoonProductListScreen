...
class ProductCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let subviews = [
            badgeLabel, favoriteButton, productImageView, addToCartButton, ratingLabel
        ]
        ...
        let labels = [
            isSponseredLbl, productNameLabel, productDetailsabel, discountLabel,
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            grayContainer.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 6),
            grayContainer.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 5),
            grayContainer.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -5),
            grayContainer.heightAnchor.constraint(equalToConstant: 240),
            ...
            favoriteButton.topAnchor.constraint(equalTo: grayContainer.topAnchor, constant: 8),
            favoriteButton.trailingAnchor.constraint(equalTo: grayContainer.trailingAnchor, constant: -8),
            ...
            detailsStackView.topAnchor.constraint(equalTo: grayContainer.bottomAnchor, constant: 8),
            detailsStackView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor,constant: 8),
            detailsStackView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor , constant: 8),
            detailsStackView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor,constant: -8),
